...
#### Run to console:
```
docker run --expose=3306 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=newpassword -e MYSQL_USER=admin -e MYSQL_PASSWORD=newpassword -e MYSQL_DATABASE=cgcat --name mysql -it mysql/mysql-server
```
