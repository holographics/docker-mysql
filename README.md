...
#### Run to console:
```
docker run --expose=3306 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=newpassword -e MYSQL_USER=pivanov -e MYSQL_PASSWORD=newpassword -e MYSQL_DATABASE=mysql --name mysql -it mysql/mysql-server
```
